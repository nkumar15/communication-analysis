...
async def run_experiment_2_evaluation():
    print("--- Starting Experiment 2 Evaluation (Hybrid Search - RRF) ---")
    ...
    # Tenant ID for Experiment 1 (Reused for Exp 2)
    tenant_id = "05b51fa4-45f4-50c2-b3f4-4c122000347b" 
    
    # Initialize Hybrid Retriever with SPECIFIC INDEX and RRF
    # The current implementation uses RRF by default now.
...
if __name__ == "__main__":
    asyncio.run(run_experiment_2_evaluation())
