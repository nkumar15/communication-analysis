...
from modules.domains.b2c.finance_trader.services.parsers.metadata import NSEDocumentMetadata
...
class RagService(BaseRagService):
    ...
    async def _enrich_metadata_hook(self, documents: List[Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            from modules.domains.b2c.finance_trader.services.parsers.metadata import MetadataExtractor
