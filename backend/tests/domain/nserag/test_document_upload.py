...
class TestDocumentUpload:
    ...
    @pytest.mark.asyncio
    async def test_upload_document_success(self, api_client: AsyncClient, nse_test_setup, mock_pdf_file):
    ...
    @pytest.mark.asyncio
    async def test_upload_document_with_metadata(self, api_client: AsyncClient, nse_test_setup, mock_pdf_file):
    ...
    @pytest.mark.asyncio
    async def test_upload_document_no_file(self, api_client: AsyncClient, nse_test_setup):
    ...
    @pytest.mark.asyncio
    async def test_upload_document_empty_filename(self, api_client: AsyncClient, nse_test_setup):
...
class TestDocumentUploadValidation:
    ...
    @pytest.mark.asyncio
    async def test_upload_invalid_tenant_id_format(self, api_client: AsyncClient, nse_test_setup, mock_pdf_file):
        """
    ...
    @pytest.mark.asyncio
    async def test_upload_different_file_types(self, api_client: AsyncClient, nse_test_setup):
