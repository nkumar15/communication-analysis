...
class WorkspacePage(BasePage):
    ...
    def create_workspace_expect_error(self, name: str, type: str = "team", error_message_part: str = None):
        # Open Modal
        self.page.get_by_role("button", name="New Workspace").click()
        ...
        expect(self.page.get_by_role("button", name="Create Workspace")).to_be_visible()
        
        if error_message_part:
            expect(self.page.get_by_text(error_message_part)).to_be_visible()
            
        # Close modal manually to clean up
